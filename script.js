const options = {
  method: 'GET',
    headers: {
        'X-RapidAPI-Key': '537c4ca388msh648adeb73163fa1p1880fdjsn578c0ec5f05a',
...
// gets recpies based on the filter option
...
async function randomRecipes (key) {
  ...
  let url = new URL('https://tasty.p.rapidapi.com/recipes/list?from=0&size=30');
